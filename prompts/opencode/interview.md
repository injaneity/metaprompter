# Metaprompter Interview — OpenCode

Invocation: `opencode run "$(cat prompts/opencode/interview.md)"`

You are running the specs-first interview phase for this repository using OpenCode.
